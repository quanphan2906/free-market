...
<div id="big-container">
    ...
    <div id="main-content" class="flex-row">
        ...
        <div class="flex-col bg-color-brand opacity-90" id="thong-tin-chung">
            <div class="color-white margin-thongtin margin-thongtin-big font-16px text-bold">Website bán hàng cũ uy tín. Dù thừa hay thiếu, chúng tôi đều đáp ứng được!</div>
            <div class="color-white margin-thongtin font-12px text-light">Trở thành một phần của đại gia đình Có không? để được kết nối với người có và người không! </div>
            <div class="color-white margin-thongtin font-12px text-light">Bằng cách đăng ký, bạn đồng ý với Nội quy dịch vụ và Quy định bảo mật </div>
        </div>
        <!-- Dang ky Zone -->
            <form id="dang-ky-zone" class="r-form flex-col center-children font-14px border-standard" action="">
                <div class="dang-ky-ele">
                    <label for="">Email</label>
                    <input class="input-text" id="email" type="email" placeholder="example@gmail.com">
                </div>
                <div class="dang-ky-ele">
                    <label for="">Password</label>
                    <input class="input-text" id="password" type="password" placeholder="Iamsoawesome">
                </div>
                <div id="err-message" class="dang-ky-ele"></div>
                <button class="btn btn-6 rounded-standard btn-medium bg-color-brand" id="dang-ky-button">{opts.loading ? "Loading...": "Đăng nhập"}</button>
                <div class="dang-ky-ele color-brand dang-nhap-link"><a href="/signup" style="color:#953F01">Chưa có tài khoản? Đăng ký!</a></div>
            </form>
    </div>
